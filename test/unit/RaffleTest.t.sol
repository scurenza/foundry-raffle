...
contract RaffleTest is CodeConstants, Test {
    ...
    function testEnteringRaffleEmitsEvent() public {
        ...
        // Our first event has only 1 indexed parameter so 1 true and the rest is false,
        // the address is the one who emit the event
    ...
    // steless fuzz testing with randomRequestId
    ...
    function testFulfillRandomWordsPicksAWinnerRestartAndSendsMoney()
        public
        raffleEntered
        skipFork
    {
